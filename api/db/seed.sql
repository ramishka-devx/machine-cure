...
-- Seed permissions
SET @perms = 'user.list,user.update,user.status.update,user.analytics,user.delete,permission.add,permission.list,permission.delete,permission.assign,permission.revoke,divisionType.add,divisionType.list,divisionType.update,divisionType.delete,division.add,division.list,division.update,division.delete,machine.add,machine.list,machine.update,machine.delete,meter.add,meter.list,meter.update,meter.delete,parameter.add,parameter.list,parameter.update,parameter.delete,breakdown.add,breakdown.list,breakdown.view,breakdown.update,breakdown.delete,breakdown.updateStatus,breakdown.assign,breakdown.startRepair,breakdown.completeRepair,breakdownCategory.add,breakdownCategory.list,breakdownCategory.update,breakdownCategory.delete,breakdownStatus.add,breakdownStatus.list,breakdownStatus.update,breakdownStatus.delete,breakdownComment.add,breakdownComment.list,breakdownComment.update,breakdownComment.delete,breakdownRepair.add,breakdownRepair.list,breakdownRepair.update,breakdownRepair.delete';
