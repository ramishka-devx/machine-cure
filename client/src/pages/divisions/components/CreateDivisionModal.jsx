...
const CreateDivisionModal = ({ isOpen, onClose, onDivisionCreated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await divisionsService.createDivision(submitData);
      ...
      if (response.success) {
        ...
        onDivisionCreated(response.data);
      } else {
    ...
    <div className="fixed inset-0 bg-gray-600/50 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div className="relative top-20 mx-auto p-5 w-96 shadow-lg rounded-md bg-white">
        ...
        <div className="flex justify-between items-center pb-3">
          <h3 className="text-lg font-medium text-gray-900">Create New Division</h3>
          <button
            onClick={handleClose}
            disabled={loading}
