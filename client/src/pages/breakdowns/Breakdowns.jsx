    ...
    return (
      <div className="max-w-6xl mx-auto p-5 animate-pulse">
        ...
        <div className="bg-white p-6 rounded-lg shadow space-y-6">
          <div className="h-8 bg-blue-200 rounded w-48"></div>
          ...
          <div className="flex gap-4 justify-end">
            <div className="h-10 w-20 bg-blue-200 rounded"></div>
          ...
          <div className="bg-gray-50 px-6 py-3 border-b border-gray-200">
            <div className="grid grid-cols-7 gap-4">
              {Array.from({ length: 7 }).map((_, index) => (
                <div key={index} className="h-4 bg-blue-200 rounded"></div>
              ))}
            </div>
          </div>
        ...
        <div className="flex justify-between items-center bg-white p-4 rounded-lg shadow border">
          ...
          <div className="flex gap-2">
            {Array.from({ length: 5 }).map((_, index) => (
              <div key={index} className="h-8 w-8 bg-blue-200 rounded"></div>
            ))}
          </div>
        </div>
      </div>
