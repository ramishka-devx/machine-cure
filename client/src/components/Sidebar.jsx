    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div className="font-semibold text-gray-900 text-base whitespace-nowrap">
              Machine Cure
            </div>
      ...
      <div className="p-4 bg-white border-t border-gray-200">
        <button
          ...
          } bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl py-2.5 px-4 transition-colors duration-200 font-medium text-sm`}
